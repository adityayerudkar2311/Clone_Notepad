...
public class About extends JFrame implements ActionListener{
    ...
    About(){
        ...
        JLabel l3 = new JLabel("<HTML>Code Created By Aditya<br>Version 0.1.0(OS Build Java)<br>All rights reserved<br which enables computer users to create documents. </html>");
